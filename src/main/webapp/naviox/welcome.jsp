...
In calcProfitOnBatches-labels_en.properties:
calcProfitOnBatches=My application
calcProfitOnBatches[description]=My application does this and that

In calcProfitOnBatches-messages_en.properties:
